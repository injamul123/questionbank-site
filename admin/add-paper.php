    ...
    if (strlen($_POST['paper-code']) < 1) {
        ...
        if ($_FILES['image-file']['error'] == 4) {
            ...
            $sql = "INSERT INTO papers
                (paper_code, paper_name, year, degree, paper_image)
                values ('$papercode' , '$papername' , '$year' , '$degree', '$fullFileName' )";
...
<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
    <a href="#"><strong><span class="fa fa-dashboard"></span> Add New Paper</strong></a>
    <hr>
...
unset($_SESSION['error']) ?>
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="paper-code" class="form-control" value=""
                                aria-describedby="emailHelp" placeholder="Enter papercode">
                        </div>
                        <div class="form-group">
